...
class WebUserDetailsScreen extends ConsumerStatefulWidget {
  const WebUserDetailsScreen({super.key});

  @override
  ConsumerState<WebUserDetailsScreen> createState() =>
      _WebUserDetailsScreenState();
}

class _WebUserDetailsScreenState
    extends ConsumerState<WebUserDetailsScreen> {
